...
Full Stack Engineer with 10+ years of experience. I've spent the majority of the past decade working on full stack web systems and infrastructure. These days I'm most confident writing Go or Node.js, but I have extensive experience with Ruby on Rails as well. In my free time, I enjoy building simple data visualization websites and exploring New York City by bike.
...
**Chemical commoditiy trading intelligence platform. Built with Go, HTMX, and Templ. Deployed with Ansible to an EC2 instance.**
...
**Founding engineer. Location-based social network. Built with Flutter, Node.js, Ruby on Rails, and GraphQL. Deployed to Heroku and GCP.**
